"""From https://github.com/rkadlec/ubuntu-ranking-dataset-creator/blob/master/src/create_ubuntu_dataset.py"""
...
def prepare_data_maybe_download(directory = "/dbfs/tmp/ubuntu/", filename = "dialogs.tgz"):
  """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', default='/dbfs/tmp/ubuntu',
